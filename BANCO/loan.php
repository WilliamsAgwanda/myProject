  ...
  <center><section class="sec1">
   ...
   <div class="container">
       <form>
           ...
           <i><h2>Loan</h2><br><br><br><br></i>
        <a href="pin7.php"><input type="button" value="Check Loan Limit"></a><br>
        <a href="loanAmount.php"><input type="button" value="Request Loan"></a><br>
