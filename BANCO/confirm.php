...
<?php
      if(isset($_POST['ok'])){
        if($pay=5555){
          $sql1="INSERT into stat(idno,deposit,dat)values('$pass',$amount,curdate());";
          $sql2="UPDATE customer set credit=credit+$amount;";
          ...
          if($r1 && $r2){
                ...
                header('location:profile.php?ErrorTryAgain');
      ...
      <div class="profile">
        ...
        <form class="form" enctype="multipart/form-data" method="POST" action=<?php $_SERVER["PHP_SELF"];?>><br><br><br>
           ...
           <div class="form-group toleft">
             ...
             <h5>Send <?php echo $amount; ?> to paybill No<br> <?php echo $pay; ?>  for Account No <br><?php echo $account;?> to MoneyTrustBank</h5>
             </div><br><br>
           
           <div class="navbar">
             <a href="profile.php"><input class="log1" type="button" value="CANCEL"></a>
