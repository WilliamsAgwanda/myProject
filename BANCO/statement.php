...
<body>
  ...
  <center><section class="sec1">
   ...
   <form class="form" enctype="multipart/form-data" method="POST" action=<?php $_SERVER["PHP_SELF"];?>>
           ...
           <i><h2>Statement</h2><br><br></i>
           <?php
              $sql2="SELECT accountno from customer where idno='$pass';";
              $r2=mysqli_query($conn,$sql2);
              while($d=mysqli_fetch_array($r2)){
                $account=$d['accountno'];
                echo'<h2>ACCOUNT NO: '.$account.'</h2>';
              }
           ?>
        ...
        <a href="down.php"><input type="button" value="DOWNLOAD"></a><br>
