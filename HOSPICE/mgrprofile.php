...
<a><img class="imp" src="prof/<?php echo $photo; ?>" class=" imp img-rounded img-responsive" style="height:100px; width:100px;"></a><?php } ?>
         ...
         <div class="navbar">
             <a href="addemployee.php"><img class="imp1" src="add.jpg"><br>Add</a>
             <a href="removeemp.php"><img class="imp1" src="remove.jpg"><br>Remove</a>
         </div>
         <div class="navbar">
            <a href="emprecords.php"><img class="imp1" src="records.jpg"><br>Records</a>
            <a href="salary.php"><img class="imp1" src="addsalary.jpg"><br>Add Salary</a>
        </div>
        <center> <div>
            <a href="inventory.php"><img class="imp1" src="inventory.jpg"><br>Inventory</a>
