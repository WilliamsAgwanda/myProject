    ...
    <i><h2>Patient's Personal Details</h2><br></i>
           ...
           <table border="1" class="table table-striped table-bordered table-hover table-condensed">
               <tr class="hds">
                  ...
                  <i><h2>Patient's Medical Records</h2><br></i>
           ...
           <table border="1" class="tbl table table-striped table-bordered table-hover table-condensed">
               <tr class="hds">
                  ...
                  <?php
                  $sql="SELECT ailment,dat from mrt where regno='$reg';";
                  $r=mysqli_query($conn,$sql);
                  while($d=mysqli_fetch_array($r)){
                   $ailment=$d['ailment'];
                   $date=$d['dat'];
          ...
          <br><br>
           <center><div class="navbar">
            <a href="addrec.php"><img class="imp2" src="admedrec.jpg"><br>Add Medical record</a>

            <a href="doclab.php"><img class="imp1" src="thelab.jpg"><br>Test</a>
