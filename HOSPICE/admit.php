...
<body>
  ...
  <center><section class="sec1">
   ...
   <form class="form" enctype="multipart/form-data" method="POST" action=<?php $_SERVER["PHP_SELF"];?>><br>
          ...
          <i><b><h2>Admit Patient</h2></b></i><br><br>
          ...
          <br><br>
           ...
           <div>
             <input class="log" type="submit" value="ADMIT" name="admit">
       ...
       <?php
         ...
         if(preg_match("/^[0-9-a-zA-Z\/]*$/",$reg)){
            ...
            $sql="INSERT into admit(regno,room,doa)values('$reg','$room',curdate());";
            $r=mysqli_query($conn,$sql);
            if($r){
              echo'<script type="text/javascript">alert("Admission done");
