  ...
  <center><section class="sec1">
   ...
   <div class="container">
       <form>
           ...
           <i><h2>Outpatients</h2><br><br><br><br></i>
           <table border="1" class=" tbl table table-striped table-bordered table-hover table-condensed">
               <tr class="hds">
                  ...
                  <?php
                  $sql="SELECT patients.regno,patients.fname,patients.lname,patients.gender,prescription.medicineInjection,prescription.dateIssued from patients,admit,prescription
                  where patients.regno!=admit.regno && patients.regno=prescription.regno && prescription.dateIssued=curdate();";
