  ...
  <center><section class="sec1">
   ...
   <div class="container">
       <form>
           ...
           <i><h2>Remove Employee</h2><br><br></i>
           <table border="1" class="table table-striped table-bordered table-hover table-condensed">
               <tr class="hds">
                  ...
                  <?php
                  $sql="SELECT idno,fname,lname,phoneno,email,position,gender from employee ;";
               ...
               echo"<tr>
                  <td>$idno</td>
                   ...
                   <td> $position </td>
                   <td>$gender </td>
                   <td><a href='rem.php?id=$idno'><button type='button' class='log' data-toggle='modal'>
