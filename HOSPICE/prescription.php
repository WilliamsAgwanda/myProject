  ...
  <center><section class="sec1">
   ...
   <div class="container">
    ...
    <i><h2>Patient Details</h2><br><br></i>
           ...
           <i><h2>Prescription Details</h2><br></i>
                   ...
                   <table border="1" class="tbl table table-striped table-bordered table-hover table-condensed">
                       <tr class="hds">
                          ...
                          <?php
                          $sql="SELECT medicineInjection from prescription where regno='$reg' && dateIssued=curdate();";
                          $r=mysqli_query($conn,$sql);
                          while($d=mysqli_fetch_array($r)){
                           $medInj=$d['medicineInjection'];
                          
                      
                          ?>
                          <tr>
                            <td><?php echo $medInj; ?></td>
