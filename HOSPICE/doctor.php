...
<a><img class="imp" src="prof/<?php echo $photo; ?>" class=" imp img-rounded img-responsive" style="height:100px; width:100px;"></a><?php } ?>
         ...
         <div class="navbar">
             <a href="docrec.php"><img class="imp1" src="inpatient.jpg"><br>Records</a>
             <a href="admit.php"><img class="imp1" src="admit.jpg"><br>Admit</a>
         </div>
         <div class="navbar">
            <a href="book.php"><img class="imp1" src="book.jpg"><br>Book</a>
            <a href="patpres.php"><img class="imp1" src="docpres.jpg"><br>Prescription</a>
        </div>
        <center> <div>
            <a href="discharge.php"><img class="imp1" src="inventory.jpg"><br>Discharge</a>
