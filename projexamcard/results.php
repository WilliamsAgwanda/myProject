  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-success">
          <div class="card-header">
            <h3 class="card-title">SELECT THE SEMESTER AND SUBMIT </h3>
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <form  action="<?php $_SERVER["PHP_SELF"];?>" method="post">
                  ...
                  <select class="form-control select2 select2-purple" name="sel" data-dropdown-css-class="select2-purple" style="width: 100%;">
        ...
        <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">SELECT UNIT TO ENTER MARKS</h3></div>
            <?php
                  if(isset($_POST['submit'])){
                   ...
                   <div class="row">
              <div class="col-12 col-sm-6">
                <form class="form-group" action="toenter.php" method="post">
    ...
    <select name="correct" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <?php
                      ...
                      $unit=$data['unit'];
                  ?>
                        <option><?php echo $code."  ".$unit?></option>
                        
                                        
                  <?php  }?></select><div class="form-group">
                  <input type="submit" name="ok" class="btn btn-danger" value="OK" ></div>
                  </form></div></div>   
                  <?php } ?>
