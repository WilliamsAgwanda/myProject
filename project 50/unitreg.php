...
<div class="wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Register Unit</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  Select Unit:
        <select  name="code" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
               <?php
               $sql1 = "SELECT unit_code,unit_name from units";
               $result1= mysqli_query($conn,$sql1);
              while($data1=mysqli_fetch_array($result1)){
              $code= $data1['unit_code'];
              $name = $data1['unit_name'];
               ?>
              <option><?php echo $code." ".$name;?></option>
 ...
 if(isset($_POST['submit'])){
  ...
  if (!empty($regno) && !empty($unitcode)) {
  $add2="SELECT user from mysql.procs_priv where host='$h' && user='$user' && Routine_name='reg_unit'";
     if (mysqli_num_rows(mysqli_query($conn,$add2))==0) {
       echo '<script>alert("You are not allowed to register units for Students or check the details and try again")</script>';
       
        exit();
     }elseif(mysqli_num_rows(mysqli_query($conn, $add2))==1) {
      $add="call reg_unit('$regno',SUBSTRING('$unitcode',1,6));";
  
      //$que= "SELECT host,user from mysql.user where host='$h' && user='$user';";
      mysqli_query($conn,$add);
      echo '<script>alert("unit registration was successful")</script>';
