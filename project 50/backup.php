...
if(isset($_POST['submit'])){
  if($user=='root' && $h=="localhost"){
     ...
     $handle=fopen('C:\Users\user\Downloads\Database\backupskool'.date("F_d_Y_h_i_s_A").'.sql','w+');
 fwrite($handle,$return);
 fclose($handle);
 echo"<script>alert('SUCCESSFULLY BACKED UP')</script>";
 }else {  echo '<script>alert("You are not allowed to backup the database")</script>';}
        ...
        <div class="col-12 col-sm-6">
          <div class="card card-success">
             ...
             <form action="<?php $_SERVER["PHP_SELF"];?>" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-success"name="submit">BACKUP DATABASE</button>
                </div>
              </form>
