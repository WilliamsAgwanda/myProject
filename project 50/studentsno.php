...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="col-12 col-sm-6">
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Students Number By School</h3>
              </div>
              <div class="card-body">
      ...
      <?php
          $add2="SELECT user from mysql.tables_priv where host='$h' && user='$user' && Table_name='studentsno'";
