      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <form action="<?php $_SERVER["PHP_SELF"];?>" method="POST" class="form-group">
                <div class="form-group">
                  Select:
                  <select  name="new" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
            ...
            <div class="row">
              ...
              <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title"><b>CREATE TABLE</b></h3>
              </div>
              <div class="card-body">
              <?php
...
<textarea name="text"><?php
  echo"create table <b>tablename</b>(<b>columns and their attributes</b>);
  ";
?>
</textarea><?php}elseif($new="View"){?>
  <textarea name="text"><?php
    echo"CREATE
...
(SELECT * FROM ...);";
  ?>
  </textarea><?php}elseif($new="Trigger"){?>
  <textarea name="text"><?php
    echo"DELIMITER $$
     CREATE
        /*[DEFINER = { user | CURRENT_USER }]*/
        TRIGGER `skool`.`jhjhjhj` BEFORE/AFTER INSERT/UPDATE/DELETE
        ON `skool`.`<Table Name>`
        FOR EACH ROW BEGIN
    ...
    DELIMITER ;";
  ?> </textarea><?php}elseif($new="StoredProcedure"){?>
    <textarea name="text"><?php
      echo"DELIMITER $$

      CREATE
          /*[DEFINER = { user | CURRENT_USER }]*/
          PROCEDURE `skool`.`jknk`()
          /*LANGUAGE SQL
          | [NOT] DETERMINISTIC
    ...
    ?></textarea><?php}?>
<div class="form-group">
     <button name="go" class="btn btn-danger">Execute Query</button>
