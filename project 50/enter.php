...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
              ...
              if(isset($_POST['ok'])){
                if (!empty($selunit)) {
                  ...
                  if (mysqli_num_rows(mysqli_query($conn,$add2))==0) {
                   ...
                   for($i=0;$i<sizeof($_POST['reno']);$i++){
                      $idd=$_POST['id'][$i];
                      $reg=$_POST['reno'][$i];
                      $ct=$_POST['ct'][$i];
                      $f=$_POST['exm'][$i];
                     //echo $idd." ".$reg." ".$ct." ".$f.''.$selunit;
                     //echo $ct+$f;
                   $t1="call sresults('$idd','$ct','$f');";
                   mysqli_query($conn,$t1);
                   
                      //header('location:results.php');
                }

                echo '<script>alert("Marks entered succesfully")</script>';
        ...
        <div class="col-12 col-sm-6">
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">ENTER RESULTS FOR: <?php echo $selunit;?></h3>
              </div>
              <div class="card-body">
     ...
     $sq1="call results(SUBSTRING('$selunit',1,6));";
           $rq1=mysqli_query($conn,$sq1);
           while($dq1=mysqli_fetch_array($rq1)){
             $id=$dq1['id'];
             $regno=$dq1['regno'];
             $cat=$dq1['cat'];
             $final_exam=$dq1['final_exam'];
         ?><tr>
           <td><input class="form-control" name="id[]" readonly type="number" value="<?php echo $id;?>"></td>
           <td><input class="form-control" name="reno[]" readonly type="text" value="<?php echo $regno;?>"></td>
           <td><input class="form-control" type="number" name="ct[]" value="<?php echo $cat;?>"></td>
           <td><input  class="form-control" type="number" name="exm[]" value="<?php echo $final_exam;?>"></td>
