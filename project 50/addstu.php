      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <form action="<?php $_SERVER["PHP_SELF"];?>" method="POST" class="form-group">
                ...
                <div class="form-group">
                  First name:
                  <input type="text" name="fn" class="form-control"placeholder="Enter firstname">
                </div>
                <div class="form-group">
                  Last Name:
                  <input type="text" name="ln" class="form-control"placeholder="Enter last name">
                </div>
                <div class="form-group">
                  School:
                  <select  name="school" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <?php $t1 = "SELECT school from schoolprogs;";
                ...
                <div class="form-group">
                  Programme:
                  <select  name="programme" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
                  <?php $t2 = "SELECT programme from schoolprogs;";
                ...
                <div class="form-group">
                  Gender:
                  <select  name="gender" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
                    <option>M</option>
                    <option>F</option>
                  </select>
                </div>
...
if(isset($_POST['submit'])){
  ...
  $conn1=mysqli_connect($h,$user,$pass,$d);
if(!$conn1){
    die("Connection failed: ".mysqli_connect_errno());
}
  
if (!empty($regno) && !empty($fn)) {


     $add2="SELECT user from mysql.procs_priv where host='$h' && user='$user' && Routine_name='studentadd'";
     if (mysqli_num_rows(mysqli_query($conn,$add2))==0) {
       echo '<script>alert("You are not allowed to add Students or check the details and try again")</script>';
       
         exit();
     }elseif(mysqli_num_rows(mysqli_query($conn,$add2))==1) {
      $add="call studentadd('$regno','$fn','$ln','$school','$programme','$gender','$email');";
  
      //$que= "SELECT host,user from mysql.user where host='$h' && user='$user';";
