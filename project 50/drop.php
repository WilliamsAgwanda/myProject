        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="drop.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Drop</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="alter.php" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Alter</p>
                    </a>
                </li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Register Semester</h3>
              </div>
              <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  Select Semester:
                  <select  name="sem" class="form-control select2 select2-purple" data-dropdown-css-class="select2-purple" style="width: 100%;">
...
if(!$conn1){
    die("Connection failed: ".mysqli_connect_errno());
     ...
     $add2="SELECT user from mysql.user where user='$user' && host='$h' && execute_priv='Y';";;
     if (mysqli_num_rows(mysqli_query($conn,$add2))==0) {
       echo '<script>alert("You are not allowed to register semester for Students or check the details and try again")</script>';
       
        exit();
     }elseif(mysqli_num_rows(mysqli_query($conn, $add2))==1) {

      $add="call sem_reg('$regno','$sem');";
  
  //$que= "SELECT host,user from mysql.user where host='$h' && user='$user';";
  mysqli_query($conn, $add);
      echo '<script>alert("semester registration was successful")</script>';
