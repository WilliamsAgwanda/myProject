...
if(isset($_POST['submit'])){
  ...
  //echo $per ." ".$dts." ". $tbl." ". $usr." ". $hst;
    $c2="revoke execute on $type $proc from '$usr'@'$hst';";
  ...
  }else {  echo '<script>alert("You are not allowed to revoke procedure privileges")</script>';} 
      ...
      <div class="container-fluid">
        ...
        <div class="row">
              ...
              <div class="card-header">
                <h3 class="card-title">Revoke Execute Permission to User</h3>
              </div>
              <div class="card-body">
