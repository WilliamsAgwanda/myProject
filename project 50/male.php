  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="col-12 col-sm-6">
          <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Male Students</h3>
              </div>
              <div class="card-body">
      ...
      <?php
          ...
          $add2="SELECT user from mysql.tables_priv where host='$h' && user='$user' && Table_name='male'";
          if (mysqli_num_rows(mysqli_query($conn,$add2))==0) {
            echo '<script>alert("You are not allowed to view this")</script>';
