...
session_start();
$regno = isset($_SESSION['regno'])?$_SESSION['regno']:0;
$idno = isset($_SESSION['idno'])?$_SESSION['idno']:0;
$prof = isset($_SESSION['pic'])?$_SESSION['pic']:0;
...
class PDF extends TCPDF{
    ...
    $pdf->cell(60,10,'This is to CERTIFY that the above information is CORRECT',0,1);
