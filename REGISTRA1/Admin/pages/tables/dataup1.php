...
session_start();
    ...
    $_SESSION['id']=$id;
    $sql = "select * from admini where pass='$id';";
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="dataupy1.php" method="post">
              <?php
             ...
             ?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="email" name="user" class="form-control" id="user" placeholder="Enter email"
                    value="<?php echo $user;?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select  name="school" class="form-control" id="school" placeholder="Enter school">
