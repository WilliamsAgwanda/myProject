...
<head>
  ...
  <title>Maseno| AdminTables</title>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  $school= $data['school'];
                     ...
                     ?><tr>
                       ...
                       <?php
                     echo "<td><a href='delete1.php?id=$pass'><button type='button' class='btn btn-danger' data-toggle='modal'>del</button></a></td>
                       <td><a href='dataup1.php?id=$pass'><button type='button' class='btn btn-primary' data-toggle='modal'>upd</button></a></td> 
                       "
                     ?>
                      </tr><?php
