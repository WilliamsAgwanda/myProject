...
<?php
    ...
    $_SESSION['id']=$id;
    $sql = "select * from student120 where adm='$id';";
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" action="dataupy.php" method="POST" enctype="multipart/form-data">
              <?php
...
?>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="lname" class="form-control" id="fname" placeholder="Enter last name"
                    value="<?php echo $lname;?>">
                  </div>
                  <div class="form-group">
                    <label for="admission">Admission Number</label>
                    <input type="text" name="adm" class="form-control" id="adm" placeholder="Enter admission number"
                    value="<?php echo $adm;?>">
                  </div>
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="idno" class="form-control" id="idno" placeholder="enter id number"
                      value="<?php echo $idno;?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="radio" name="gender"  value="other" id="gender" >other</div>
                  <div class="form-group">
                    <label for="profile">profile</label>
                    <input type="file" name="file" class="form-control" value="<?php echo $prof;?>">
                    <?php }
                    ?>
                  </div>
