...
$sql = "SELECT * FROM student120 WHERE adm='$adm3';";
...
class PDF extends TCPDF{
    ...
    $pdf->cell(60,10,'This is to CERTIFY that the above student has been issued with an HOSTEL',0,1);
    $pdf->cell(60,10,'HOSTEL ..................................................................',0,1);
    $pdf->cell(60,10,"STUDENT'S SIGN ----------------------------",0,1);
    $pdf->Ln(10);
    $pdf->SetFont('Helvetica','B',15);
    $pdf->cell(60,10,"FOR REGISTRA",0,1);
    $pdf->cell(60,10,"SIGN ......................... DATE AND STAMP............................",0,1);
    $pdf->Output('hostelStage.pdf');
}
?>